  ...
  return (
    <section className="w-auto">
      ...
      <div className="flex w-auto flex-wrap justify-center gap-4 rounded-md text-lg text-sky-500">
        {/* MERCHANT ICON */}
        <div className="flex flex-1 flex-col justify-center rounded-md border border-gray-300 bg-transparent px-2 shadow-md">
        ...
        <div className="flex-1 justify-center rounded-md border border-gray-300 bg-transparent p-5 text-center shadow-md">
          <h1>Tasks / Logs</h1>
          <div className="">
            <Image
